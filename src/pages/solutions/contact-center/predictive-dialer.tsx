    ...
    <main className="pt-16">
      ...
      <section className="py-16 sm:py-20">
        <div className="container-custom text-center">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">Ready to Revolutionize Your Outreach?</h2>
          <p className="mt-4 text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Find out how our Predictive Dialer can transform your call center's efficiency and drive unparalleled results.
          </p>
