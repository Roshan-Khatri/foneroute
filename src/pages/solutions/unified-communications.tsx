...
const UnifiedCommunicationsPage: FC = () => {
  return (
    <>
      ...
      <div className="bg-white dark:bg-[#191919] py-32">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-center mb-8 text-gray-900 dark:text-white">Unified Communications</h1>
          <div className="max-w-3xl mx-auto">
            <p className="text-lg text-gray-700 dark:text-[#9CA3AF] mb-6">
            ...
            <ul className="list-disc list-inside text-gray-700 dark:text-[#9CA3AF] space-y-2">
